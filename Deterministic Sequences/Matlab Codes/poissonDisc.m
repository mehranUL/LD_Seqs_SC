% Generating bit-stream related to Poisson Disk sequence.
pt = poissonDisc([1500,1500,1500],7.5,1024);

%Mohak (2023). mohakpatel/Poisson-Disc-Sampling (https://github.com/mohakpatel/Poisson-Disc-Sampling), GitHub. Retrieved April 25, 2023.
