...
%  Input:
%
%    integer MAXV gives the dimension of the array V.
%
%    integer PX_DEG, the degree of polynomial PX.
%
%    integer PX(PXDEG+1), the appropriate irreducible polynomial
%    for the dimension currently being considered.  The degree of PX
%    will be called E.
%
%    integer ADD(2,2), MUL(2,2), SUB(2,2), the addition, multiplication, 
%    and subtraction tables, mod 2.
%
%    integer B_DEG, the degree of the polynomial B.
%
%    integer B(B_DEG+1), the polynomial defined in section 2.3 of BFN.  
...
%  Output:
%
%    integer PC_DEG, the degree of the polynomial C = B * PX.
%
%    integer PC(PC_DEG+1), the polynomial C = B * PX.
%
%    integer V(MAXV+1), the computed V array.
%
%  Local:
%
%    integer ARBIT, indicates where the user can place
%    an arbitrary element of the field of order 2.  This means
%    0 <= ARBIT < 2.
%
%    integer BIGM, is the M used in section 3.3.
%    It differs from the [little] m used in section 2.3,
%    denoted here by M.
%
%    integer NONZER, shows where the user must put an arbitrary
