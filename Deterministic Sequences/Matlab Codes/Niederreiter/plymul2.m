...
%  Input:
%
%    integer ADD(2,2), MUL(2,2), the addition and multiplication 
%    tables, mod 2.
%
%    integer PA_DEG, the degree of polynomial A.
%
%    integer PA(PA_DEG+1), the coefficients of polynomial A.
%
%    integer PB_DEG, the degree of polynomial B.
%
%    integer PB(PB_DEG+1), the coefficients of polynomial B.
%
%  Output:
%
%    integer PC_DEG, the degree of polynomial C.
%
%    integer PC(PC_DEG+1), the product polynomial, C = A * B mod 2.
%
